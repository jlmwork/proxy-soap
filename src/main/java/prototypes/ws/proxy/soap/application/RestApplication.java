...
import prototypes.ws.proxy.soap.exchange.SoapExchangeResource;
import prototypes.ws.proxy.soap.sample.SampleResource;
import prototypes.ws.proxy.soap.web.rest.CustomContextResolver;
import prototypes.ws.proxy.soap.web.rest.JpaEntityProcessor;
...
public class RestApplication extends ResourceConfig {
    ...
    public RestApplication() {
        ...
        packages(SoapExchangeResource.class.getPackage().getName(),
                SampleResource.class.getPackage().getName(),
                ProxyConfiguration.class.getPackage().getName(),
                CustomContextResolver.class.getPackage().getName());
